...
export const SPOTLIGHT_CONTENT: SpotlightContent[] = [
  ...
  },
  {
    ...
    description: 'Immigration and Customs Enforcement (ICE) operates a nationwide detention system for individuals in removal proceedings or awaiting immigration hearings. The system includes government-owned facilities, privately contracted detention centers, and intergovernmental service agreements with local jails.',
    keyFacts: [
      {
      ...
      },
      {
        ...
        value: '~41,500 detention beds authorized by Congress (FY2024)'
      },
      {
  ...
  },
  {
    ...
    description: 'Medicare is the federal health insurance program primarily for Americans aged 65 and older, and some younger people with disabilities or End-Stage Renal Disease. Established in 1965, it consists of four parts: Part A (hospital insurance), Part B (medical insurance), Part C (Medicare Advantage), and Part D (prescription drug coverage).',
    keyFacts: [
      {
        label: 'Beneficiaries',
  ...
  },
  {
    ...
    description: 'The Gerald R. Ford class is the newest generation of nuclear-powered aircraft carriers for the U.S. Navy, designed to replace the aging Nimitz class. These carriers feature electromagnetic aircraft launch systems, advanced arresting gear, dual-band radar, and improved flight deck efficiency allowing 25% more sorties per day.',
    keyFacts: [
      {
        label: 'Cost to Build',
        value: '$13.3 billion per ship (including R&D for lead ship USS Gerald R. Ford)'
      },
      {
      ...
      {
        label: 'Current Fleet',
        value: '11 carriers total: 1 Ford-class operational, 2 under construction, 8 Nimitz-class'
      }
    ],
    controversy: 'The Ford-class program has been criticized for massive cost overruns (originally projected at $10.5B per ship), years of delays, and technical problems with new systems including the electromagnetic catapult (EMALS), advanced arresting gear, and weapons elevators. USS Gerald R. Ford took 4 years after commissioning to become fully operational. Critics question whether such expensive platforms are vulnerable to modern anti-ship missiles and whether the budget could be better spent on smaller, distributed capabilities. The Navy argues carriers provide unmatched power projection, diplomatic presence, and crisis response capability that no alternative can match.',
    sources: [
      {
