...
export const ICE_SPENDING_DATA: ICESpendingData = {
  ...
  categories: [
    {
      ...
      description: "Custody operations, transportation, removal, and alternatives to detention",
      subcategories: [
        {
          ...
          percentage: 67.9,
          description: "Daily detention operations across ICE facilities and contracted centers",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 892_000_000,
          percentage: 17.7,
          description: "Air and ground transportation for detainees, removals, and deportation operations",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 448_000_000,
          percentage: 8.9,
          description: "GPS monitoring, case management, and SmartLINK mobile app supervision",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 280_000_000,
          percentage: 5.6,
          description: "Apprehension teams, warrant execution, and enforcement operations",
          metrics: [
            {
    ...
    },
    {
      ...
      description: "Criminal investigations, counter-proliferation, transnational crime, and cybercrime",
      subcategories: [
        {
          ...
          amount: 892_000_000,
          percentage: 36.0,
          description: "Multi-agency task forces targeting transnational criminal organizations",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 618_000_000,
          percentage: 25.0,
          description: "Investigations into human trafficking, child exploitation, and smuggling networks",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 446_000_000,
          percentage: 18.0,
          description: "Operations targeting MS-13, cartels, and international gang networks",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 372_000_000,
          percentage: 15.0,
          description: "Money laundering, trade-based money laundering, and cyber investigations",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 148_000_000,
          percentage: 6.0,
          description: "Preventing illegal export of weapons, technology, and sensitive materials",
          metrics: [
            {
    ...
    },
    {
      ...
      description: "Leadership, human resources, financial management, and mission support",
      subcategories: [
        {
        ...
        },
        {
          ...
          amount: 146_000_000,
          percentage: 30.0,
          description: "Office space, operational facilities, and infrastructure maintenance"
        },
        {
          id: "it-systems",
          ...
          amount: 97_000_000,
          percentage: 20.0,
          description: "Technology infrastructure, case management systems, and modernization"
        },
        {
          id: "legal-services",
          name: "Legal Services",
    ...
    },
    {
      ...
      description: "New facility construction, bed space expansion, and major renovations",
      subcategories: [
        {
          id: "new-facilities",
          ...
          amount: 568_000_000,
          percentage: 67.5,
          description: "Construction of new ICE detention facilities to increase capacity",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 186_000_000,
          percentage: 22.1,
          description: "Modernization of existing facilities, safety improvements, and compliance"
        },
        {
          ...
          amount: 88_000_000,
          percentage: 10.4,
          description: "Security systems, medical facilities, and operational infrastructure"
        }
      ]
    },
    {
      ...
      description: "Immigration court support, legal representation costs, and case processing",
      subcategories: [
        {
          ...
          amount: 191_000_000,
          percentage: 50.0,
          description: "Legal coordination for detained individuals in proceedings"
        },
        {
          ...
          amount: 115_000_000,
          percentage: 30.1,
          description: "Case management and coordination with immigration courts"
        },
        {
          ...
          amount: 76_000_000,
          percentage: 19.9,
          description: "Legal appeals, habeas corpus cases, and federal litigation"
        }
      ]
    },
    {
      ...
      description: "Healthcare for detainees, mental health services, and medical operations",
      subcategories: [
        {
          id: "medical-care",
          ...
          amount: 174_000_000,
          percentage: 60.0,
          description: "Primary care, emergency services, and ongoing medical treatment",
          metrics: [
            {
        ...
        },
        {
          ...
          amount: 87_000_000,
          percentage: 30.0,
          description: "Psychological services, crisis intervention, and counseling"
        },
        {
          id: "pharmaceutical",
  ...
  keyMetrics: [
    ...
    },
    {
      ...
      value: "41,500",
      change: "+8.7%",
      description: "Increase from 37,800 in FY2024, significant rise from 22,100 in FY2021"
    },
    {
      label: "Daily Detention Cost Per Person",
      value: "$150.75",
      change: "+12.3%",
      description: "Up from $134.23 in FY2023, includes housing, food, medical care, security"
    },
    {
    ...
    },
    {
      ...
      value: "$4.12",
      description: "GPS monitoring and case management - 97.3% cheaper than detention"
    },
    {
      label: "Facility Construction Investment",
      value: "$842M",
      change: "+266%",
      description: "Major increase from $230M in FY2024 for expanded capacity"
    },
    {
      label: "Average Removal/Deportation Cost",
      value: "$10,854",
      description: "Per-person cost including transportation, processing, and country coordination"
    },
    {
      label: "ICE Air Operations",
      value: "4,200+ flights",
      description: "Annual charter and removal flights for deportations and transfers"
    },
    {
      label: "HSI Criminal Investigations",
      value: "27,000+",
      description: "Annual investigations into trafficking, smuggling, and transnational crime"
    },
    {
    ...
    },
    {
      ...
      value: "53%",
      description: "Over half of ICE budget dedicated to enforcement and removal operations"
    },
    {
      label: "YoY Budget Increase",
      value: "+8.9%",
      change: "+$780M",
      description: "FY2025 increase driven by detention expansion and facility construction"
    }
  ]
};
...
export function getCategoryTotal(categoryId: string): number {
  const category = ICE_SPENDING_DATA.categories.find(cat => cat.id === categoryId);
 ...
 */
export function getYoYChangePercent(currentYear: number, previousYear: number): number {
  const current = ICE_SPENDING_DATA.historicalData.find(d => d.year === currentYear);
  const previous = ICE_SPENDING_DATA.historicalData.find(d => d.year === previousYear);

  if (!current || !previous) return 0;

  return ((current.totalBudget - previous.totalBudget) / previous.totalBudget) * 100;
}
