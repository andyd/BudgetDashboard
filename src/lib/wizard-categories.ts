...
export function getBudgetItemsForCategory(
  ...
  const mapping: Record<WastefulCategory, string[]> = {
    defense: [
      ...
      "program-virginia-submarine",
      "program-columbia-submarine",
      "program-b21-bomber",
      "program-abrams-tank",
      "program-overseas-bases",
      "program-military-bands",
    ...
    "foreign-aid": [
      "dept-state",
      "prog-foreign-military-aid",
      "prog-military-aid-israel",
      "prog-military-aid-egypt",
      "prog-foreign-economic-aid",
      "prog-embassy-operations",
    ],
    admin: [
      "dept-justice",
      "prog-congressional-operations",
      "prog-congressional-salaries",
      "prog-secret-service",
      "prog-white-house-operations",
      "prog-presidential-travel",
      "event-presidential-travel",
      "event-white-house-operations",
      "event-congressional-salaries",
      "event-air-force-one",
    ],
    "farm-subsidies": ["dept-usda", "prog-farm-subsidies"],
    interest: [
      "dept-treasury",
      "prog-improper-payments",
      "prog-expired-programs",
      "prog-duplicative-programs",
      "prog-tax-gap",
      "prog-pentagon-unaccounted",
      "prog-fossil-fuel-subsidies",
      "prog-corporate-tax-breaks",
    ],
    other: [
      "prog-improper-payments",
      "prog-expired-programs",
