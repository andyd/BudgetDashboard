...
interface BudgetOverviewModuleProps {
  ...
  /** Callback when a budget item is hovered */
  onItemHover?: (departmentId: string | null) => void;
}
...
export const BudgetOverviewModule = memo<BudgetOverviewModuleProps>(
  function BudgetOverviewModule({ budgetData, onItemHover }) {
    ...
    return (
      <section className="border-t border-slate-800 bg-slate-900/50">
        <div className="container mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          ...
          <p className="mb-4 text-center text-sm text-slate-400 sm:mb-6">
            Hover over a segment to see comparisons above
          </p>
