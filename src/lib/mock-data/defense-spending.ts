 ...
 * Based on approximate FY2024 budget figures
 * Total DoD Budget: ~$850B
 */
...
export const DEFENSE_SPENDING_DATA: DefenseSpendingData = {
  totalBudget: 850_000_000_000, // $850B
  fiscalYear: 2024,
  ...
  categories: [
    {
      ...
      percentage: 21.2,
      description: "Salaries, benefits, and allowances for active duty, reserve, and National Guard personnel",
      subcategories: [
        {
          id: "active-duty-pay",
    ...
    },
    {
      ...
      percentage: 35.3,
      description: "Day-to-day operations, training, maintenance of equipment and facilities",
      subcategories: [
        {
          ...
          percentage: 40.0,
          description: "Training exercises, operational deployments, fuel, and supplies"
        },
        {
          ...
          percentage: 28.3,
          description: "Maintenance and repair of aircraft, ships, vehicles, and weapons systems"
        },
        {
          id: "base-operations",
          ...
          percentage: 18.3,
          description: "Utilities, facility maintenance, security, and base services"
        },
        {
    ...
    },
    {
      ...
      percentage: 20.0,
      description: "Acquisition of new weapons systems, equipment, and technology",
      subcategories: [
        {
          id: "aircraft",
          ...
          programs: [
            ...
            },
            {
              ...
              description: "C-130J, V-22 Osprey, trainers, UAVs, and other aircraft"
            }
          ]
        },
        {
          ...
          programs: [
            ...
            },
            {
              ...
              amount: 2_500_000_000,
              description: "Amphibious ships, support vessels, and ship modifications"
            }
          ]
        },
        {
        ...
        },
        {
          ...
          amount: 20_000_000_000,
          percentage: 11.8,
          description: "Space systems, communications, electronics, and other equipment",
          programs: [
            {
              id: "satellite-systems",
              name: "Satellite Systems",
              amount: 6_500_000_000,
              description: "GPS III, communications satellites, and space systems"
            },
            {
              id: "cybersecurity",
    ...
    },
    {
      ...
      percentage: 16.5,
      description: "Development of next-generation weapons, technology, and innovation",
      subcategories: [
        {
          ...
          amount: 35_000_000_000,
          percentage: 25.0,
          description: "Next-generation fighters, bombers, and aviation technology",
          programs: [
            {
              id: "ngad",
          ...
          programs: [
            {
              ...
              description: "AI-enabled weapons, autonomous systems, decision support"
            },
            {
              id: "cyber-ops",
          ...
          programs: [
            {
              ...
              name: "DARPA Programs",
              amount: 7_200_000_000,
              description: "Defense Advanced Research Projects Agency initiatives"
            },
            {
    ...
    },
    {
      ...
      percentage: 1.8,
      description: "Construction of facilities, infrastructure, and family housing",
      subcategories: [
        {
      ...
      subcategories: [
        {
          ...
          percentage: 60.0,
          description: "Utilities, repairs, and maintenance of existing housing"
        },
        {
...
export function getCategoryTotal(categoryId: string): number {
  const category = DEFENSE_SPENDING_DATA.categories.find(c => c.id === categoryId);
