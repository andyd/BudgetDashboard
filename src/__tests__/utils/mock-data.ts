...
export const mockComparisonResults: ComparisonResult[] = [
  ...
  },
  {
    ...
    unitCount: Math.floor(79_000_000_000 / 40_000),
    formattedString:
      "Department of Education equals 1.9 million Tesla Model 3s",
    category: "transportation",
  },
];
...
/**
 * Budget amounts for common US federal spending categories (FY2025)
...
export const UNIT_COSTS = {
  ...
  IPHONE: 999.0,
  MACBOOK: 1_299.0,
  TESLA_MODEL_3: 40_000.0,
  MEDIAN_HOME: 412_000.0,
  FERRARI: 250_000.0,
  PRIVATE_JET: 5_000_000.0,
} as const;
